...
class ForgeAPI:
    ...
    def update_env_file(self, site_id: str, content: str):
        return self._request("POST", f"/orgs/{self.organization}/servers/{self.server_id}/sites/{site_id}/env", data={"content": content})
...
def main():
    try:
        ...
        # --- 3. Initialiser l'API ---
        organization = get_input("forge_organization", "clemrep")  # Par défaut "clemrep"
